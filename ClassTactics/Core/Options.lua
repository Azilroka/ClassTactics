...
function CT:BuildOptions()
	...
	for i = 1, GetNumClasses() do
		...
		for specGroup = 1, GetNumSpecializationsForClassID(classID) do
			...
			specOption.args.ActionBars.args.buttons.args.SaveActionBarSet = ACH:Execute('Save ActionBar Set', nil, 3, function() CT:SetupActionBarPopup(CT.OptionsData[classTag][specGroup].SelectedActionBarSet) end, nil, nil, nil, nil, nil, nil, function() return classTag ~= CT.MyClass or specGroup ~= GetSpecialization() end)
